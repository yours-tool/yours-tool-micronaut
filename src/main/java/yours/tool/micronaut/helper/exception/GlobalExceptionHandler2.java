...
//import com.shuanghedan.edanpei.common.exception.BaseException;
//import com.shuanghedan.edanpei.common.exception.DefaultException;
//import com.shuanghedan.edanpei.common.response.ResultResponse;
//import com.shuanghedan.edanpei.common.util.ValidateUtil;
...
//
//    private final Logger log = LoggerFactory.getLogger(GlobalExceptionHandler2.class);
//
//    /**
//     * 异常捕获
//     *
...
//    @ResponseBody
//    public ResultResponse<Void> authorityException(AuthorityException e) {
//        log.error("【系统抛出authorityException】 —— 异常内容如下：{}", e);
//        return ResultResponse.ofException(e.getResultStatusEnum().getCode()
//                , ValidateUtil.isEmpty(e.getMessage()) ? e.getResultStatusEnum().getMessage() : e.getMessage());
//    }
//
//    /**
//     * 这个错误只存在手动抛出异常的情况
...
//    @ResponseBody
//    public ResultResponse<Void> defaultException(BaseException e) {
//        log.error("【系统BaseException异常】 —— 异常内容如下：{}", e);
//        return ResultResponse.ofException(e.getResultStatusEnum());
//    }
//
//    /**
//     * 这个错误只存在手动抛出异常的情况
...
//    @ResponseBody
//    public ResultResponse<Void> defaultException(DefaultException e) {
//        log.error("【系统DefaultException异常】 —— 异常内容如下：{}", e);
